...
<html>
<head>
	<title>Pharmacist Feedback</title>
...
<div class="row">
<div class="col-md-1">
	<a href="pharmacist.php" class="btn btn-success">Back</a></div>
	<div class="col-md-8">
		<div class="card">
			...
			<div class="card-body">			
				<form class="form-group" action="config.php" method="post">
					...
					<input type="submit" name="phar_feedback_submit" value="Submit" class="btn btn-primary">
				</form>
			</div>
		</div>
	</div>
