...
<body id="b">
	 <div id="d"> 
	 	<form action="phr_login.php" method="POST" align="center"> 
	 		...
	 		<br>
			  ...
			  <label>User-Name</label>
	 		  ...
	 		  <input type="submit" name="phr_login"class="btn btn-success" value="Log-In">
	 		  <a href="phr_reg.php"><input type="button" name="phr_reg" class="btn btn-primary" value="Registration"></a>
	 	</form>
	 	
	 	<?php
	 	/*log_in button a click holo kina!!!*/
	 	if(isset ($_POST ['phr_login'])){
	 		/*user j email r pass dilo seta amr db tey ache kina!! tar check...*/
	 		$username = $_POST['username'];
	 		$password = $_POST ['password'];

	 			$query = "select * from phr_reg where username = '$username' AND password = '$password' ";
	 			...
	 			if($check){
	 				...
	 				echo "
	 					...
	 					window.location.href = 'phr_login.php';
	 					</script>
	 					";
	 				/*query else*/
	 			}
