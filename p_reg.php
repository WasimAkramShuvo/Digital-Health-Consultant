...
<body id="b">
	 <div id="d"> 
	 	<form action="p_reg.php" method="POST" align="center">
	 		<center><img src="images/patient.png" class="img" align="center"></center>
			  ...
			  <label>User-Name</label>
	 		  ...
	 		  <input type="submit" name="p_reg" class="btn btn-success" value="Sign-Up">

	 		  <a href="p_login.php"><input type="button" name="back" class="btn btn-primary" value="Back to Log-In"></a>
	 	</form>

	 	<!-- registration from thekey db tey connect -->
	 	<?php
	 	/*sign-p button a click holo kina!!!*/
	 	if (isset($_POST ['p_reg'])) {/*isset = pre defined function */
	 		...
	 		if ($password == $cpass) {
	 			$query = "select * from p_reg where email= '$email'";/*1 ta email 1 bar i hbe...test.*/
	 			...
	 			if($query_check){
	 				...
	 				if(mysqli_num_rows ($query_check > 0)){
	 					...
	 					$insertion = "INSERT INTO p_reg(username, email, password)
	 					...
	 					window.location.href ='p_reg.php'; 
