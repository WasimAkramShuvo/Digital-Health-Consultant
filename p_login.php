...
<body id="b">
	 <div id="d"> 
	 	<form action="p_login.php" method="POST" align="center"> 
	 		...
	 		<br>
			  ...
			  <label>User-Name</label>
	 		  ...
	 		  <input type="submit" name="p_login"class="btn btn-success" value="Log-In">
	 		  <a href="p_reg.php"><input type="button" name="p_reg" class="btn btn-primary" value="Registration"></a>
	 	</form>
	 	...
	 	if(isset ($_POST ['p_login'])){
	 		...
	 		$password = $_POST ['password'];
	 			...
	 			$query = "select * from p_reg where username = '$username' AND password = '$password' ";
