...
<body id="b">
	 <div id="d"> 
	 	<form action="d_reg.php" method="POST" align="center">
	 		<center><img src="images/doctor.png" class="img" align="center"></center>
			  ...
			  <label>User-Name</label>
	 		  ...
	 		  <input type="submit" name="d_reg" class="btn btn-success" value="Sign-Up">

	 		  <a href="d_login.php"><input type="button" name="back" class="btn btn-primary" value="Back to Log-In"></a>
	 	</form>

	 	<!-- registration from thekey db tey connect -->
	 	<?php
	 	/*sign-p button a click holo kina!!!*/
	 	if (isset($_POST ['d_reg'])) {/*isset = pre defined function */
	 		...
	 		if ($password == $cpass) {
	 			$query = "select * from d_reg where email= '$email'";/*1 ta email 1 bar i hbe...test.*/
	 			...
	 			if($query_check){
	 				...
	 				if(mysqli_num_rows ($query_check > 0)){
	 					...
	 					window.location.href = 'd_login.php'; </script>";
	 					/*email register hoar por login a pathano lagbe..*/
	 				}
	 				else {
	 					$insertion = "INSERT INTO d_reg(username, email, password)
